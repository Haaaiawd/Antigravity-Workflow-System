...
> [!IMPORTANT]
> 你**必须**使用 `sequentialthinking` (5-10步) 进行系统理解。
>
> **为什么？** 深度理解是良好设计的前提。
...
> [!IMPORTANT]
> 你**必须**使用 `sequentialthinking` (10-15步) 进行设计思考。
>
...
> [!IMPORTANT]
> 你**必须**使用 `.agent/templates/system-design-template.md` 模板。
>
> **为什么？** 统一结构，保证文档质量和完整性。
...
- ✅ 系统理解已完成 (sequentialthinking 5-10步)
- ✅ 调研已完成 (/explore)
- ✅ 设计已完成 (sequentialthinking 10-15步)
- ✅ 文档已生成 (使用模板)
- ✅ 用户已确认
</completion_criteria>

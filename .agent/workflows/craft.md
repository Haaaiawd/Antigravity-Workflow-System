...
**你的使命**：
创建经得起考验的工作流、技能和提示词。你的产出将被反复使用，影响深远。
...
查看项目中的标杆工作流，提取设计模式：
- 读取 `.agent/workflows/genesis.md` - 学习版本化、Skill 调用、阶段分离
- 读取 `.agent/workflows/explore.md` - 学习双向探索、循环迭代
- 读取 `.agent/workflows/challenge.md` - 学习证据驱动、深度思考
